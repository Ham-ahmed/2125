...
url=https://raw.githubusercontent.com/Ham-ahmed/2125/refs/heads/main/multi-stalkerpro-1.2-aarch64-bv.tar.gz
sleep 3
else
url=https://raw.githubusercontent.com/Ham-ahmed/2125/refs/heads/main/multi-stalkerpro-1.2-aarch64-ape.tar.gz
sleep 3
fi;;
*)
echo "> your image python version: $python is not supported"
...
if [[ "$IMAGE" == "openvix" || "$IMAGE" == "openblackhole" ]]; then
https://raw.githubusercontent.com/Ham-ahmed/2125/refs/heads/main/multi-stalkerpro-1.2-mips-bv.tar.gz
sleep 3
else
https://raw.githubusercontent.com/Ham-ahmed/2125/refs/heads/main/multi-stalkerpro-1.2-mips-ape.tar.gz
sleep 3
fi;;
*)
echo "> your image python version: $python is not supported"
...
if [[ "$IMAGE" == "openvix" || "$IMAGE" == "openblackhole" ]]; then
url=https://raw.githubusercontent.com/Ham-ahmed/2125/refs/heads/main/multi-stalkerpro-1.2-arm-bv.tar.gz
sleep 3
else
url=https://raw.githubusercontent.com/Ham-ahmed/2125/refs/heads/main/multi-stalkerpro-1.2-mips-ape.tar.gz
sleep 3
fi;;
*)
echo "> your image python version: $python is not supported"
